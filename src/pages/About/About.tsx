...
const About = () => {
   ...
   return(
      <section id="about" className="w-full h-screen min-h-[1050px] gap-16 dark:bg-neutral-950 dark:bg-opacity-10 px-56 flex flex-col pt-24 items-center"> 
      <div className="relative z-[-1] flex cursor-default items-center justify-center text-center">
         ...
         <div className="relative gap-10">
            ...
            <div className="absolute top-52 left-full ml-10 ">

...
const Skill = () => {
  ...
  return (
    <div className="skills flex flex-col items-center justify-center gap-6">
      <div
        className="flex max-w-[1300px] items-center justify-center flex-wrap gap-16 mt-10 max-[700px]:gap-8 2xl:gap-24 skills"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        <IconContext.Provider
          value={{ className: "global-stacks" }}
        >
          <FaHtml5
            className="text-[#F16529]"
            onClick={() => setTech(0)}
          />
          <FaCss3Alt
            className="text-[#1172B8]"
            onClick={() => setTech(1)}
          />
          <FaBootstrap
            className="text-[#552d91]"
            onClick={() => setTech(2)}
          />
          <FaGitAlt
            className="text-[#EE513B]"
            onClick={() => setTech(3)}
          />
          <FaGithub onClick={() => setTech(4)} />
          <FaReact
            className="text-[#53C1DE]"
            onClick={() => setTech(5)}
          />
          <IoLogoJavascript
      ...
      <div
        className="flex mt-5 flex-col gap-2 justify-center items-center cursor-default max-w-[30rem]"
        data-aos="fade-up"
        data-aos-delay="300"
      >
        <h2 className="text-2xl dark:text-neutral-200 text-neutral-800 font-bold">
          {techsInform[techInfo].name}
        </h2>

...
const Header = () => {
   ...
   return(
         <nav className="navbar fixed z-50 w-full inset-x-0 xl:px-[18rem] lg:px-[5rem] min-w-[30rem] top-0 h-20 bg-zinc-200 dark:bg-zinc-900 dark:bg-opacity-60 px-64 dark:backdrop-blur-md text-white backdrop-blur-md bg-opacity-50">

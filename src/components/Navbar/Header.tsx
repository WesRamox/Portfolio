...
const Header = () => {
   ...
   return(
         <nav className="navbar fixed inset-x-0 top-0 h-20 bg-slate-50 dark:bg-zinc-900 dark:bg-opacity-60 dark:backdrop-blur-md text-white lg:px-56 px-56 backdrop-blur-md bg-opacity-50">
